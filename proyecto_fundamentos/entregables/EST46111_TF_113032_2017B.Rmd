...
A partir de lo anterior, puede extenderse el modelo para considerar un modelo jerárquico que responda si existe diferencias entre las mediciones. El modelo se define de la siguiente manera:
...
Siguiendo el modelo utiliando 5000 iteraciones, 3 cadenas y quemando las primeras 1000, se puede observar que cero pertenece al intervalo de la beta, por lo que no se rechaza la hipótesis nula, lo que implica que no existen diferencias entre las mediciones realizadas en papel o electrónicamente. 
